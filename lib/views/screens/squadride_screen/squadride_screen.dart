          ...
          child: SingleChildScrollView(
            child: Column(children: [
                            ...
                            child: Padding(
                                ...
                                child: selectedFilter == index
                                    ? FilterButton(
                                        ...
                                        isActive: true)
                                    : FilterButton(title: _filter_list[index])),
                          )),
                ),
              ),
              Padding(
                        ...
                        child: Column(
                          ...
                          (index) => Padding(
                            ...
                            child: InkWell(
                              ...
                              child: PlayerCard(
                                playerId: _playercardList[index].playerId,
                                playerImage: _playercardList[index].playerImage,
              ...
              Visibility(
                  ...
                  child: Container(
                    height: squadPlayerList.values.toList().length > 2 ? 340 : 170,
                    width: MediaQuery.of(context).size.width,
                    decoration: BoxDecoration(
                        ...
                        child: SizedBox(
                          ...
                          child: Column(
                            children: [
                              ...
                              Row(
                                  ...
                                  children: List.generate(3, (index) {
                                    return Container(
                                        ...
                                        child: squadPlayerList.values
                                                    .toList()
                                                    .length >
                                                index
                                            ? Stack(
                                                children: [
                                                  Image.asset(squadPlayerList
                                                      .values
                                                      .toList()[index]
                                                      .playerImage),
                                                  Positioned(
                              ...
                              squadPlayerList.values.toList().length > 2
                                  ? Padding(
